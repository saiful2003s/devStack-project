...
const Banner = () => {
    return (
        <div className='mx-3 md:mx-10 mt-10 md:mt-10'>
            <div className='container mx-auto grid lg:grid-cols-2 items-center text-center lg:text-left'>
                <div>
                    ...
                    <p className='my-3 lg:my-10'>Explore frontend, backend, database, and tooling options,<br className='hidden md:block' />

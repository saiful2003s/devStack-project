...
const Technologies = ({ technologiesPromise }: TechnologiesProps) => {
    ...
    return (
        ...
        <div className='md:mx-10 mx-3 my-0 md:my-20'>
            <div className='container mx-auto '>
                <div className='text-center md:text-left'>
                    <h2 className='font-extrabold text-[30px] md:text-[36px] leading-10 tracking-[-0.9px] text-[#0F172A]'>Explore the
                ...
                <div className='grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-2 lg:gap-5'>
